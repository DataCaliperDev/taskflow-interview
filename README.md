...
>
> The implementation plan that drove this PR is included at the end of this document — see [Implementation Plan](#-implementation-plan-drafted-before-any-code-changed). It documents the decision tree (auth-migration strategy, scope discipline, harness rewrite) and reflects the final state.
...
## 🧠 Implementation Plan (drafted before any code changed)

_This is the plan I worked from. It documents the decision tree (auth-migration strategy, scope discipline, harness rewrite) and the final state._
